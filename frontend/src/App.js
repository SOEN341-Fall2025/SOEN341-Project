            ...
            <Modal.Body>
              ...
              <form onSubmit={handleSubmitGallery}>
                <Col>
                  ...
                  <Row><input type='text' id='newName-gallery' value={newName} onChange={(e) => setNewName(e.target.value)} placeholder='Name of your new Gallery' /></Row>
          ...
          <Modal.Dialog>
            ...
            <Modal.Body>
              ...
              <form onSubmit={handleSubmitChannel}>
                <Col>
                  <Row><label>Name:</label></Row>
                  <Row><input type='text' id='newName-channel' value={newChannelName} onChange={(e) => setNewChannelName(e.target.value)} placeholder='Name of your new Channel' /></Row>
                  <Row><input type='submit' value="Submit" onClick={handleClose} /></Row>
                </Col>
              </form>
            </Modal.Body>
